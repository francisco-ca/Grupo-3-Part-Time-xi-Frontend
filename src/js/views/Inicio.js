            ...
            <div className= "fond borde2" >
                ...
                <Row className="m-4">
                    ...
                    <Col className="text-center"  md={{ size: 'auto' } }>
                            <div className=" p-2 text-justify bordes m-2">
                        <p >
                        ...
                        <Row className="m-4">
                            <Link to="/ingreso" className="btn  botone">Inicia Sesión</Link>
                        </Row>
                        <Row className="m-4">
                            <Link to="/registro" className="btn botone text-center">Regístrate. Es gratis </Link>
                        </Row >
